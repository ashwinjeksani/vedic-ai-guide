...
const SUGGESTIONS = {
  en: [
    ...
    { tag: "Staying active in age", q: "In old age, with so many health problems, how do I stay active and keep myself occupied?" },
  ...
  hi: [
    ...
    { tag: "उम्र में सक्रिय रहना", q: "बुढ़ापे में, इतनी सारी स्वास्थ्य समस्याओं के बीच, मैं सक्रिय कैसे रहूँ और खुद को कैसे व्यस्त रखूँ?" },
  ...
  te: [
    ...
    { tag: "వయసులో చురుకుగా", q: "వృద్ధాప్యంలో, ఇన్ని ఆరోగ్య సమస్యల మధ్య, నేను చురుకుగా ఎలా ఉండాలి, నన్ను నేను ఎలా నిమగ్నం చేసుకోవాలి?" },
  ...
  zh: [
    ...
    { tag: "老年如何充实", q: "年老了，健康问题这么多，我该如何保持活力、让自己有事可做？" },
